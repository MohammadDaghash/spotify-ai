...
function TopBar() {
  ...
  const { searchArtist, isName, loading } = useSpotify();
  ...
  return (
    <div className="h-14 bg-black flex items-center justify-between px-4 text-white">
      ...
      <div className="flex items-center gap-3 w-[40%]">
        ...
        <div className="realative flex items-center gap-2 bg-[#1f1f1f] px-4 py-2 rounded-full w-full hover:bg-[#2a2a2a]">
          ...
          {showDropdown && resultArtist && (
            <div className="absolute top-12 center w-100 bg-[#181818] rounded-md shadow-lg p-2 z-50">
              <div
